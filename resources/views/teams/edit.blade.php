...
@section('script')
    <script>
        ...
        function populateDropDowns() {
            var year = $('#year').val();
            var selected_div = '{{ request()->old('division_id', $team->division_id ) }}';
            ...
            for(var cat in divList[year]) {
                ...
                for(var div_id in divList[year][cat]) {
                    selected = (div_id == selected_div) ? 'selected="selected"' : '';
            ...
            var selected_invoice = '{{ request()->old('invoice_id', $thisInvoice->id) }}';
            ...
            for(var invoice_id in invoiceList[year]) {
                ...
                selected = (invoice_id_actual == selected_invoice) ? 'selected="selected"' : '';
