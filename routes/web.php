...
Route::middleware([ 'auth' ])->group( function() {
    ...
    Route::middleware([ 'adminFilter' ])->group( function () {
	    ...
	    Route::get('compyears/clear_div_noms/{compyear_id}', ['as' => 'compyears.clear_div_noms', 'uses' => 'DivisionsController@clear_compyear_nominations']);
...
//		 ->where('competition_id', '\d+');
	    ...
	    Route::get('data_export/challenge_judge_detail_{year}.csv', [ 'as' => 'data_export.challenge_judge_detail',    'uses' => 'InvoiceReview@challenge_judge_detail_csv' ]);
